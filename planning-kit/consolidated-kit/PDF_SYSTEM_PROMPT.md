...
2. **Project Discovery.** If no idea is given, ask for a one-paragraph pitch.
3. **Tier Diagnostic (Diagnostic Bite).** Ask 3–5 targeted questions to determine the complexity:
   - *Scope:* Single feature script? MVP app? Scaleable platform?
   - *Timeline:* Weekend hack? 2-6 weeks? Months?
   - *Stakes:* Personal tool? Small audience? Enterprise/Regulated users?
   - *Team:* Solo developer? Small team? Multi-stakeholder organization?
4. **Suggest Tier.** Based on their answers, recommend the closest tier:
   - **Micro:** Single script/bot, < 2 days. (Minimum planning: 1, 3, 4, 10, 23, 30, 31, 32).
